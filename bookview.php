    ...
    <body>
      ...
      <div class="container-fullwidth" style="background-color: black;color: white;">
        ...
        <?php
          ...
          $result = $conn->query($q);
          $sql="SELECT * FROM `whishlist` WHERE whishedby = '".$_SESSION['user']."' AND bookid='$id'";
          $res = $conn->query($sql);
          $sql="SELECT * FROM `interestlist` WHERE interestedby = '".$_SESSION['user']."'AND bookid='$id'";
          $r = $conn->query($sql);
        ?>
                    ...
                    <div class="col-sm-12">
                      <div class="list-wrapper">
                          <?php if ($result->num_rows > 0) {
                            ...
                            <div class="col-sm-12">
                              <div class="list-item">
                                <div id="slideshow_1_thumbs_1" class="col-lg-3 col-md-3 col-sm-3">
                                  <ul class="slideshow1_thumbs desoslide-thumbs-vertical list-inline text-center">
                                    <?php 
                                    $pic = explode("@@",$value['book_cover']);
                                    foreach ($pic as $val) {?>
                                      <li>
                                          <a href="<?php echo 'admin/pages/forms/'. str_replace("admin/pages/forms/", '', $val);?>">
                                              <img src="<?php echo 'admin/pages/forms/'. str_replace("admin/pages/forms/", '', $val);?>" data-desoslide-caption-title="<?php echo $value['bookname'];?>" width="200px" height="200px">
                                          </a>
                                      </li><br><br><br>
                                    <?php
                                    }
                                ...
                                <div id="slideshow1" class="col-lg-6 col-md-6 col-sm-6">
                                  <div id="slideshow1" class="col-lg-8 col-md-8 col-sm-8"></div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-3" style="">
                                    <p>TITTLE : <?php echo $value['bookname'];?></p>
                                    <p>AUTHOR : <?php echo $value['author'];?></p>
                                    <p>PRICE : <?php echo $value['price']!=0?$value['price']:"FREE";?></p>
                                    ...
                                    <div style="display: flex;text-align: center;justify-content: space-between;">
                                      ...
                                      <?php if ($res->num_rows > 0) {
                                        foreach ($res as $value) { 
                                          if ($value['whishedby']==$_SESSION['user']) { ?>
...
<!--         <nav>
            ...
            <ul>
                ...
                <li><a href="#">Help</a></li>
                <li><a class="active" href="SignIN_UP.html">Sign In</a></li>
