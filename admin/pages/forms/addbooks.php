            ...
            <div class="card card-primary">
              ...
              <form name="add_book_form" id="add_book_form" action="" method="" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Book Cover</label>
                    <input type="file" class="form-control" id="book_cover"  name="book_cover[]" placeholder="Upload images" accept="image/jpeg,image/gif,image/png" required="">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">Authur name</label>
                    <input type="text" class="form-control" id="author"  name="author" placeholder="Enter Authur name" required="">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Is free</label>
                  ...
                  <div class="form-group" id="price_div">
                    ...
                    <input type="number" class="form-control" id="price"  name="price" placeholder="Enter " required="">
                  </div>
                  ...
                  <div class="form-group" id="published_date_div">
                    ...
                    <input type="text" class="form-control" id="published_date"  name="published_date" placeholder="Enter Date" required="" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Publisher</label>
                    <input type="text" class="form-control" id="publisher"  name="publisher" placeholder="Enter " required="">
                  </div>
                  <div class="form-group">
              ...
              success: function (result)
              {
                ...
                if ((result==1) || (result=="")) {
                  setTimeout(function () {
                      ...
                      window.location.href = "http://localhost/Erms/admin/pages/forms/viewbooks.php";
                  }, 2000);
                }else{
