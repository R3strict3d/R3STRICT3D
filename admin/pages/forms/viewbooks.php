      ...
      <div class="container-fluid">
        ...
        <tbody>
          ...
          <tr>
              ...
              <td><button class="btn btn-danger" onclick="deletebook('<?php print_r($value['id']) ;?>')" data-toggle="modal" data-target="#myModal">Delete</button> | <button class="btn btn-success" onclick="showbook('<?php print_r($value["id"]); ?>','<?php print_r($value["staus"]); ?>')"><?php if($value['staus']=="ACTIVE")  {echo "Hide";} else {echo "Show"; } ?></button></td>
          </tr>
          <?php 
          }
        }
