        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div id='suc_msg' class="alert alert-success no-border" style="display:none;">
                ...
                <span class="text-semibold"><b>Password Successfully Updated</b></span><span id="suc_content"></span>
            </div>
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form name="settings_form" id="settings_form" novalidate="">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="Password" class="form-control" id="cpassword"  name="cpassword" placeholder="Enter Confirm New Password" required="">
                  </div>
                  <div class="form-group">
